...
gantt
    ...
    Fase 1 — Inventario y Canales           :f2, after f1, 2w
    Fase 2 — Facturación, Cotizaciones e Integración :f3, after f2, 2w
    Fase 3 — Hardware, Capacitación y Go Live        :crit, f4, after f3, 2w
