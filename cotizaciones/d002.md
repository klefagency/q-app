...
gantt
    ...
    Fase 0 — Fundación y Cuentas Shopify    :f1, 2026-03-16, 2w
...
**Fase 0 — Fundación y Cuentas Shopify** *(Semanas 1–2)*
...
**Fase 1 — Seguimiento Sistema kitchencleanvalenzuela.net** *(Semanas 1–8, continuo)*
...
* **Plataformas recurrentes:** Shopify Basic ~$25 USD/mes.
...
1. Disponibilidad técnica del sistema y su infraestructura.
2. Documentación funcional o técnica de endpoints, APIs o métodos de integración.
3. Estabilidad operativa del sistema en ambiente productivo.
4. Acceso a credenciales necesarias y, de ser posible, a un ambiente de pruebas o staging.
